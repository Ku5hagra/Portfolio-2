  ...
  state={
    ...
    onSubmit=async (AddingElement,event)=>{
      ...
      const NewElement={
        ...
        const response= await axios.post("http://127.0.0.1:9000/api/project",NewElement);
        const issuccess=response.data.issuccessful;
        
            
            if(issuccess){
                this.setState({
                    submitmessage:"Project added successfully!",
    ...
    AddingElement("projects",NewElement);
    }
      ...
      <div className='container-fluid bg-dark py-5 '>
        <div className="row pl-auto ">
           ...
           <div className="col-12 col-lg-5">
               <h1 className='font-weight-light text-light text-center pt-5 mb-0 '><span style={{color:"lightgreen"}}>Add </span>Project</h1><br /><br /><br />
